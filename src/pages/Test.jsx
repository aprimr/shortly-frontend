    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-gray-800 p-4">
      ...
      {!showOTPForm ? (
        <div className="bg-gray-900 p-8 rounded-lg w-full max-w-sm md:max-w-md lg:max-w-lg">
          <h2 className="text-3xl text-white md:text-4xl font-semibold text-center mb-6">Verify Account</h2>
        ...
        <div className="bg-gray-900 p-8 rounded-lg w-full max-w-sm md:max-w-md lg:max-w-lg">
          ...
          <h2 className="text-3xl text-white md:text-4xl font-semibold text-center mb-3">Verify OTP</h2>
          <p className="block text-emerald-400 mb-4 text-sm md:text-xl text-center">
            Please enter the OTP sent to your email to verify your account.
          </p>
          <form onSubmit={handleSubmitOTP}>
            <div className="mb-4">
              <label className="block text-gray-300 mb-2 text-lg">Enter OTP</label>
              <input
                type="text"
                maxLength="6"
        ...
        <div className="bg-gray-900 p-8 rounded-lg w-full max-w-sm md:max-w-md lg:max-w-lg">
          ...
          <h2 className="text-3xl text-white md:text-4xl font-semibold text-center mb-3">Success</h2>
          <p className="block text-emerald-400 mb-4 text-sm md:text-xl text-center">
